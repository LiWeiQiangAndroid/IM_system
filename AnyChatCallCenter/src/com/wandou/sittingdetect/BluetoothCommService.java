...
public class BluetoothCommService implements Serializable{
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(SittingDetectService.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(SittingDetectService.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(SittingDetectService.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(SittingDetectService.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SittingDetectService.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(SittingDetectService.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SittingDetectService.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SittingDetectService.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(SittingDetectService.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
